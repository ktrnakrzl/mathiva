...
class MathivaApp extends StatelessWidget {
  ...
  static final GoRouter _router = GoRouter(
    ...
    routes: [
      ...
      GoRoute(path: RouteNames.subjects, builder: (_, __) => const MathSubjectsScreen()),
      GoRoute(path: RouteNames.imageSolver, builder: (_, __) => const ImageSolverScreen()),
      GoRoute(path: RouteNames.progress, builder: (_, state) => ProgressOverviewScreen(scrollToAchievements: state.extra == true)),
      GoRoute(path: RouteNames.profile, builder: (_, __) => const ProfileSettingsScreen()),
      GoRoute(path: RouteNames.chat, builder: (_, __) => const ChatScreen()),
      GoRoute(path: RouteNames.solution, builder: (_, __) => const SolutionScreen()),
      GoRoute(path: '/quiz', builder: (_, __) => const QuizScreen()),
      GoRoute(path: '/review', builder: (_, __) => const ReviewQueueScreen()),
      GoRoute(path: '/mastery', builder: (_, __) => const MasteryHeatmapScreen()),
  ...
  static Map<String, dynamic> _args(GoRouterState state) {
    return (state.extra as Map?)?.cast<String, dynamic>() ?? <String, dynamic>{};
  }
