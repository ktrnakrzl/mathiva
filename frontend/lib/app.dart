            ...
            switch (settings.name) {
              case RouteNames.lessons:
                return MaterialPageRoute(
                    builder: (_) =>
                        LessonListScreen(subjectId: args['subjectId']!));
              ...
              case RouteNames.concept:
                return MaterialPageRoute(
                    builder: (_) => ConceptReadingScreen(
                        subjectId: args['subjectId']!,
                        topicId: args['topicId']!,
                        lessonId: args['lessonId']!,
              ...
              case RouteNames.conceptProgress:
                return MaterialPageRoute(
                    builder: (_) => ConceptProgressScreen(
                        subjectId: args['subjectId']!,
                        topicId: args['topicId']!,
                        lessonId: args['lessonId']!));
              ...
              case RouteNames.subjectProgress:
                return MaterialPageRoute(
                    builder: (_) =>
                        SubjectProgressScreen(subjectId: args['subjectId']!));
              case RouteNames.topicAnalytics:
                return MaterialPageRoute(
                    builder: (_) => TopicAnalyticsScreen(
                        subjectId: args['subjectId']!,
                        topicId: args['topicId']!));
            }
