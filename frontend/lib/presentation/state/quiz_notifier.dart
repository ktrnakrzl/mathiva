...
class QuizNotifier extends StateNotifier<AsyncValue<QuizSession>> {
  ...
  QuizNotifier(this._questionRepository)
  ...
  Future<void> submitAnswer(String sessionId, int questionIndex, String answer) async {
    final currentState = state;
    if (currentState is! AsyncValue<QuizSession> || currentState.value == null) {
      return;
    }
