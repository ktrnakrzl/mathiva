...
final subjectProgressProvider = FutureProvider.family<SubjectProgress, ({String userId, String subjectId})>(
  (ref, params) async {
    final progressRepository = ref.watch(progressRepositoryProvider);
    return progressRepository.getSubjectProgress(params.userId, params.subjectId);
  },
);
