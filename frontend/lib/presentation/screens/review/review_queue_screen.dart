                    ...
                    child: _SoftCard(
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        Container(
                          ...
                          child: Text('Due: ${item.due_date}', style: TextStyle(color: palette.primary, fontWeight: FontWeight.w800)),
                        ),
                        const SizedBox(height: 14),
                        MathRenderer(text: item.question_text, textStyle: const TextStyle(color: _ink, fontWeight: FontWeight.w800), mathFontSize: 16),
                        const SizedBox(height: 12),
                        ...item.choices.map((choice) => Padding(padding: const EdgeInsets.only(bottom: 6), child: Text('• $choice', style: const TextStyle(color: _muted)))),
                      ]),
                    ),
                  ),
                );
