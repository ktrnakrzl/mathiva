      ...
      body: state.when(
        data: (progress) => ListView(
          ...
          children: [
            ...
            _HomeTile(title: 'Subjects', subtitle: 'Choose a Mathiva subject', route: '/subjects'),
            _HomeTile(title: 'Tutor', subtitle: 'Ask the RAG math tutor', route: '/tutor'),
            _HomeTile(title: 'Quiz', subtitle: 'Practice with adaptive questions', route: '/quiz'),
            _HomeTile(title: 'Review Queue', subtitle: 'Spaced repetition review', route: '/review'),
            _HomeTile(title: 'Mastery', subtitle: 'Track topic mastery', route: '/mastery'),
            _HomeTile(title: 'Rewards', subtitle: 'View points and badges', route: '/rewards'),
          ],
        ),
