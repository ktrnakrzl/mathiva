...
class QuizQuestionScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<QuizQuestionScreen> createState() =>
    ...
    return Scaffold(
      ...
      body: sessionAsync.when(
        ...
        data: (session) {
          ...
          final progress = ((session.currentQuestionIndex + 1) /
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    DifficultyBadge(
                      difficulty: currentQuestion.difficulty.toString().split('.').last,
                    ),
                  ],
                ),
              ),
                  ...
                  child: ElevatedButton(
                    onPressed: _selectedAnswer == null || _isSubmitting
                        ...
                        : () async {
                            ...
                            await ref.read(quizNotifierProvider.notifier)
                                .submitAnswer(
                              widget.sessionId,
                            ...
                            ref.listen(quizNotifierProvider,
                                (previous, next) {
