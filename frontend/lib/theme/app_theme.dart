  ...
  static ThemeData light([MathiviaPalette? palette]) {
    ...
    return ThemeData(
      ...
      switchTheme: SwitchThemeData(
        thumbColor: MaterialStateProperty.resolveWith((states) => states.contains(MaterialState.selected) ? active.primary : null),
        trackColor: MaterialStateProperty.resolveWith((states) => states.contains(MaterialState.selected) ? active.primary.withOpacity(.35) : null),
      ),
