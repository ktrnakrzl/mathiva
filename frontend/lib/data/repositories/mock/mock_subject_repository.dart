...
class MockSubjectRepository implements SubjectRepository {
  final List<Subject> _subjects = [
    ...
    Subject(
        ...
        grade_level: 'Grade 11'),
    Subject(
        subject_id: 'precalc', name: 'Pre-Calculus', grade_level: 'Grade 12'),
    Subject(
        subject_id: 'basic_calc',
        name: 'Basic Calculus',
  ...
  Future<List<Topic>> getTopics(String subjectId) async {
    ...
    return [
      Topic(
          topic_id: '${subjectId}_functions',
          name: 'Functions',
          difficulty_available: const ['Easy', 'Medium', 'Hard']),
      Topic(
          topic_id: '${subjectId}_equations',
          name: 'Equations',
          difficulty_available: const ['Easy', 'Medium', 'Hard']),
      Topic(
          topic_id: '${subjectId}_applications',
          name: 'Applications',
          difficulty_available: const ['Easy', 'Medium', 'Hard']),
    ];
  }
