import 'package:mathiva_flutter/core/models/models.dart';
...
class MockData {
  ...
  static final sampleQuestions = [
    QuestionModel(
      ...
      solutionSteps: '[{"step": 1, "text": "Try to find rational roots using synthetic division"}, {"step": 2, "text": "Test x=1: 1-6+11-6=0, so x=1 is a root"}]',
      pointsReward: 10,
    ),
    QuestionModel(
      questionId: 'q2',
      ...
      solutionSteps: '[{"step": 1, "text": "Use quadratic formula: x = (-b ± √(b²-4ac)) / 2a"}]',
      pointsReward: 8,
    ),
  ];
  ...
  static final sampleTutorMessages = [
    ...
    TutorMessage(
      ...
      content: 'Great question! Let me help you solve this quadratic equation. We can use factoring here. Notice that we need two numbers that multiply to 6 and add to -5. Those are -2 and -3.',
      latexFormula: r'x^2 - 5x + 6 = (x-2)(x-3) = 0',
      timestamp: DateTime.now().subtract(const Duration(minutes: 4)),
      references: ['polynomial_factoring_method.pdf', 'quadratic_equations_guide.pdf'],
    ),
    TutorMessage(
      messageId: 'msg3',
      sender: MessageSender.tutor,
      content: 'So our solutions are x = 2 and x = 3. You can verify by substituting back into the original equation.',
      latexFormula: null,
