import 'package:mathiva_flutter/data/repositories/progress_repository.dart';
...
class MockProgressRepository implements ProgressRepository {
  ...
  Future<void> updateProgress(
    ...
    print('[MockProgress] Updated user $userId with $pointsEarned points for topic $topicId');
  }
}
