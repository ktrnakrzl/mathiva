...
class QuizStartRequest {
  ...
  QuizStartRequest({required this.student_id, required this.subject_id, required this.topic_id, required this.difficulty, required this.item_count});
...
class QuizQuestion {
  ...
  QuizQuestion({required this.question_id, required this.question_text, required this.choices});
...
class AnswerRequest {
  ...
  AnswerRequest({required this.quiz_id, required this.question_id, required this.student_answer});
  Map<String, dynamic> toJson() => {'quiz_id': quiz_id, 'question_id': question_id, 'student_answer': student_answer};
}
...
class AnswerResponse {
  ...
  AnswerResponse({required this.is_correct, required this.correct_answer, required this.solution_steps});
...
class QuizResult {
  ...
  QuizResult({required this.score, required this.total, required this.passed, required this.wrong_items, required this.points_earned});
