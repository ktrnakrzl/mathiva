...
class SubjectProgress {
  ...
  SubjectProgress(
      ...
      required this.mastery_percent,
      required this.topics_completed});
...
class Badge {
  ...
  Badge(
      {required this.badge_id, required this.name, required this.earned_date});
