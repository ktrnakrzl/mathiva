              ...
              child: LayoutBuilder(
                builder: (context, constraints) {
                  ...
                  return GestureDetector(
                    ...
                    onPanUpdate: (details) =>
                        _onPanUpdate(details.delta, size),
  ...
  void _onPanUpdate(Offset delta, Size size) {
    ...
    setState(() {
      switch (_activeHandle) {
        case 0: // top-left
          _crop = Rect.fromLTRB(
            math.min(_crop.left + dxF, _crop.right - _minSize)
                .clamp(0.0, 1.0),
            math.min(_crop.top + dyF, _crop.bottom - _minSize)
                .clamp(0.0, 1.0),
            _crop.right,
            _crop.bottom,
          );
        ...
        case 1: // top-right
          _crop = Rect.fromLTRB(
            ...
            math.min(_crop.top + dyF, _crop.bottom - _minSize)
                .clamp(0.0, 1.0),
            math.max(_crop.right + dxF, _crop.left + _minSize)
                .clamp(0.0, 1.0),
            _crop.bottom,
          );
          break;
        case 2: // bottom-left
          _crop = Rect.fromLTRB(
            ...
            _crop.top,
            _crop.right,
            math.max(_crop.bottom + dyF, _crop.top + _minSize)
                .clamp(0.0, 1.0),
          );
          break;
        case 3: // bottom-right
