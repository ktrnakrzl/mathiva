...
_COMPATIBLE_TEMPLATE_ALIASES: Dict[str, Callable[[str, random.Random], GeneratedQuestion]] = {
    # General Mathematics
    "relations": _linear_domain_range_template,
    "one_to_one_functions": _inverse_linear_template,
    "introduction_to_rational_functions": _rational_domain_template,
    "rational_equations": _rational_domain_template,
    "rational_inequalities": _rational_domain_template,
    "applications_of_rational_functions": _function_solve_input_template,
    "exponential_growth": _exponential_equation_template,
    "exponential_decay": _exponential_equation_template,
    "applications_of_exponential_functions": _exponential_equation_template,
    "laws_of_logarithms": _log_equation_template,
    "logarithmic_functions": _log_equation_template,
    "solving_two_step_equations": _function_solve_input_template,
    "equations_with_parentheses": _function_solve_input_template,
    "substitution_systems": _slope_template,
    "elimination_systems": _slope_template,
    "compound_interest": _simple_interest_template,
    "present_value": _simple_interest_template,
    "ordinary_annuities": _simple_interest_template,
    "general_annuities": _simple_interest_template,
    "sinking_funds": _simple_interest_template,
    "amortization": _simple_interest_template,
    "consumer_loans": _simple_interest_template,
    # Statistics and Probability
    "population_and_sample": _mean_template,
    "variables": _mean_template,
    "types_of_data": _mode_template,
    "sampling_techniques": _probability_formula_template,
    "experimental_design": _probability_formula_template,
    "frequency_distribution": _mean_template,
    "histograms": _range_template,
    "bar_graphs": _range_template,
    "pie_charts": _probability_formula_template,
    "stem_and_leaf_plots": _median_template,
    "box_plots": _median_template,
    "ogives": _median_template,
    "weighted_mean": _mean_template,
    "variance": _range_template,
    "standard_deviation": _z_score_template,
    "interquartile_range": _range_template,
    "quartiles": _median_template,
    "deciles": _median_template,
    "percentiles": _median_template,
    "conditional_probability": _probability_formula_template,
    "independent_and_dependent_events": _probability_complement_template,
    "bayes_theorem": _probability_formula_template,
    "permutations": _counting_principle_template,
    "combinations": _counting_principle_template,
    "random_variables": _probability_formula_template,
    "discrete_probability_distributions": _probability_formula_template,
    "binomial_distribution": _probability_formula_template,
    "normal_distribution": _z_score_template,
    "reading_bar_graphs": _range_template,
    "interpreting_line_graphs": _slope_template,
    "sampling_distributions": _mean_template,
    "confidence_intervals": _mean_template,
    "hypothesis_testing": _mean_template,
    "correlation": _slope_template,
    "simple_linear_regression": _slope_template,
    # Pre-Calculus
    "radical_functions": _function_definition_template,
    "absolute_value_functions": _function_definition_template,
    "piecewise_functions": _function_definition_template,
    "angles": _sine_cosine_template,
    "degree_measure": _sine_cosine_template,
    "radian_measure": _sine_cosine_template,
    "unit_circle": _sine_cosine_template,
    "graphs_of_trigonometric_functions": _sine_cosine_template,
    "inverse_trigonometric_functions": _cosine_ratio_template,
    "trigonometric_equations": _sine_cosine_template,
    "law_of_sines": _sine_cosine_template,
    "law_of_cosines": _cosine_ratio_template,
    "coordinate_plane": _distance_formula_template,
    "midpoint_formula": _distance_formula_template,
    "parallel_and_perpendicular_lines": _slope_template,
    "graphing_conic_sections": _circle_standard_template,
    "applications_of_conic_sections": _circle_standard_template,
    "triangle_angle_sum": _sine_cosine_template,
    "area_of_triangle": _sine_cosine_template,
    "soh_cah_toa": _sine_cosine_template,
    "degree_radian_conversion": _sine_cosine_template,
    "harmonic_sequences": _arithmetic_sequence_template,
    # Basic Calculus
    "one_sided_limits": _limit_meaning_template,
    "infinite_limits": _limit_meaning_template,
    "continuity": _limit_meaning_template,
    "product_rule": _coefficient_power_rule_template,
    "quotient_rule": _coefficient_power_rule_template,
    "chain_rule": _coefficient_power_rule_template,
    "implicit_differentiation": _coefficient_power_rule_template,
    "normal_lines": _basic_power_rule_template,
    "concavity": _coefficient_power_rule_template,
    "curve_sketching": _coefficient_power_rule_template,
    "fundamental_theorem_of_calculus": _antiderivative_power_template,
    "basic_substitution": _antiderivative_power_template,
    "average_value_of_function": _antiderivative_power_template,
    "accumulation_functions": _antiderivative_power_template,
    "differential_equations_intro": _antiderivative_power_template,
    "initial_value_problems": _function_solve_input_template,
}

for _concept_id, _template in _COMPATIBLE_TEMPLATE_ALIASES.items():
    TEMPLATES.setdefault(_concept_id, (_alias(_concept_id, _template),))
